...
const agencyContent = {
    ...
    <div class="p-8 text-black font-[Cordia New] leading-relaxed relative" style="font-family: 'Cordia New', sans-serif; font-size: 16pt;">
        ...
        <div class="flex justify-between items-start mb-8">
            <div></div> <!-- Logo placeholder if needed later -->
        ...
        <!-- Attachments -->
         <div class="mt-12 break-before-page">
            ...
            <div>
                ...
                <!-- Normally this would be dynamic, but since the agent is fixed, maybe they want a fixed image? 
                     For now, using the uploaded field in case they want to attach it per contract, or we could leave it blank.
                     The user request implies the template has this section. -->
...
async function main() {
    console.log('Setting up Agency Agreement template...');
