...
const DEFAULT_LEASE_LAYOUT = `<div class="max-w-[210mm] mx-auto p-8 leading-relaxed text-black" style="font-family: 'Cordia New', sans-serif; font-size: 14pt;">
  <h1 class="text-center font-bold mb-6" style="font-size: 16pt;">LEASE AGREEMENT/สัญญาเช่า</h1>
            ...
            {activeTab === 'fields' ? (
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button
                            onClick={() => {
                                if (confirm('การโหลด Template จะทับข้อมูล Layout และโครงสร้างฟอร์มปัจจุบัน ยืนยันหรือไม่?')) {
                                    setData({
                                        ...data,
