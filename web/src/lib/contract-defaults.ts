...
export const DEFAULT_LEASE_SECTIONS = [
  {
    id: 'sec_contract',
    title: 'ข้อมูลสัญญา',
    fields: [
...
export const DEFAULT_LEASE_LAYOUT = `<style>
              ...
              <div class="signature-box" style="text-align: center; width: 45%;">
                <div style="position: relative; height: 50px; margin-bottom: 5px;">
                   <div style="position: absolute; bottom: 0; width: 100%; z-index: 10;">
                        ลงชื่อ <span style="border-bottom: 1px dotted black; width: 150px; display: inline-block;"></span> ผู้ให้เช่า
                   </div>
                   <img src="{{lessorSignature}}" style="height: 40px; position: absolute; bottom: 5px; left: 50%; transform: translateX(-50%); z-index: 20; display: {{lessorSignature ? 'block' : 'none'}}" />
                </div>
                <div>Lessor</div>
              </div>
              <div class="signature-box" style="text-align: center; width: 45%;">
                <div style="position: relative; height: 50px; margin-bottom: 5px;">
                   <div style="position: absolute; bottom: 0; width: 100%; z-index: 10;">
                        ลงชื่อ <span style="border-bottom: 1px dotted black; width: 150px; display: inline-block;"></span> ผู้เช่า
                   </div>
                   <img src="{{lesseeSignature}}" style="height: 40px; position: absolute; bottom: 5px; left: 50%; transform: translateX(-50%); z-index: 20; display: {{lesseeSignature ? 'block' : 'none'}}" />
                </div>
                <div>Lessee</div>
              </div>
            </div>
...
export const DEFAULT_RECEIPT_SECTIONS = [
  {
    id: "sec_info",
    title: "ข้อมูลใบเสร็จ",
    fields: [
...
export const DEFAULT_AGENCY_SECTIONS = [
  {
    id: "sec_info",
...
export const DEFAULT_BUY_SECTIONS = [
  {
    id: "sec_info",
    title: "ข้อมูลสัญญา",
    fields: [
...
export const DEFAULT_BUY_LAYOUT = `<style>
  @import url('https://fonts.googleapis.com/css2?family=Sarabun:wght@400;700&display=swap');
  @media print {
    @page {
      size: A4;
        ...
        <td style="height: 30mm; vertical-align: bottom;">
            <div class="signature-footer">
              <div class="signature-box" style="text-align: center; width: 45%;">
                <div style="position: relative; height: 50px; margin-bottom: 5px;">
                   <div style="position: absolute; bottom: 0; width: 100%; z-index: 10;">
                        ลงชื่อ <span style="border-bottom: 1px dotted black; width: 150px; display: inline-block;"></span> ผู้จะขาย
                   </div>
                   <img src="{{lessorSignature}}" style="height: 40px; position: absolute; bottom: 5px; left: 50%; transform: translateX(-50%); z-index: 20; display: {{lessorSignature ? 'block' : 'none'}}" />
                </div>
                <div>Seller</div>
              ...
              <div class="signature-box" style="text-align: center; width: 45%;">
                <div style="position: relative; height: 50px; margin-bottom: 5px;">
                   <div style="position: absolute; bottom: 0; width: 100%; z-index: 10;">
                        ลงชื่อ <span style="border-bottom: 1px dotted black; width: 150px; display: inline-block;"></span> ผู้จะซื้อ
                   </div>
                   <img src="{{lesseeSignature}}" style="height: 40px; position: absolute; bottom: 5px; left: 50%; transform: translateX(-50%); z-index: 20; display: {{lesseeSignature ? 'block' : 'none'}}" />
                </div>
                <div>Buyer</div>
...
export const DEFAULT_AGENCY_LAYOUT = `<style>
  @import url('https://fonts.googleapis.com/css2?family=Sarabun:wght@400;700&display=swap');
  @media print {
    @page {
      size: A4;
        ...
        <td style="height: 30mm; vertical-align: bottom;">
            <div class="signature-footer">
              <div class="signature-box" style="text-align: center; width: 45%;">
                <div style="position: relative; height: 50px; margin-bottom: 5px;">
                   <div style="position: absolute; bottom: 0; width: 100%; z-index: 10;">
                        ลงชื่อ <span style="border-bottom: 1px dotted black; width: 150px; display: inline-block;"></span> เจ้าของทรัพย์
                   </div>
                   <img src="{{lessorSignature}}" style="height: 40px; position: absolute; bottom: 5px; left: 50%; transform: translateX(-50%); z-index: 20; display: {{lessorSignature ? 'block' : 'none'}}" />
                </div>
                <div>Owner</div>
              ...
              <div class="signature-box" style="text-align: center; width: 45%;">
                <div style="position: relative; height: 50px; margin-bottom: 5px;">
                   <div style="position: absolute; bottom: 0; width: 100%; z-index: 10;">
                        ลงชื่อ <span style="border-bottom: 1px dotted black; width: 150px; display: inline-block;"></span> นายหน้า
                   </div>
                   <img src="{{lesseeSignature}}" style="height: 40px; position: absolute; bottom: 5px; left: 50%; transform: translateX(-50%); z-index: 20; display: {{lesseeSignature ? 'block' : 'none'}}" />
                </div>
                <div>Agent</div>
...
export const DEFAULT_RESERVATION_SECTIONS = [
  {
    id: "sec_project",
...
export const DEFAULT_RESERVATION_LAYOUT = `<style>
  @import url('https://fonts.googleapis.com/css2?family=Sarabun:wght@400;700&display=swap');
  @media print {
    @page {
      size: A4;
  ...
  <table style="width: 100%; border-collapse: collapse;">
    ...
    <div class="flex justify-between items-start mb-6">
        ...
        <div class="text-center w-2/3">
            <div class="font-bold text-2xl text-blue-800 mb-1">รายละเอียดการจองห้องเช่า</div>
            <div class="font-bold text-xl text-blue-600">Rental Reservation</div>
        </div>
    </div>
        ...
        <td style="height: 30mm; vertical-align: bottom;">
            ...
            <div class="signature-footer">
              <div class="signature-box" style="text-align: center; width: 45%;">
                <div style="position: relative; height: 50px; margin-bottom: 5px;">
                   <div style="position: absolute; bottom: 0; width: 100%; z-index: 10;">
                        ลงชื่อ <span style="border-bottom: 1px dotted black; width: 150px; display: inline-block;"></span> ผู้อนุมัติ
                   </div>
                   <img src="{{lessorSignature}}" style="height: 40px; position: absolute; bottom: 5px; left: 50%; transform: translateX(-50%); z-index: 20; display: {{lessorSignature ? 'block' : 'none'}}" />
                </div>
                <div>Approved By</div>
              ...
              <div class="signature-box" style="text-align: center; width: 45%;">
                <div style="position: relative; height: 50px; margin-bottom: 5px;">
                   <div style="position: absolute; bottom: 0; width: 100%; z-index: 10;">
                        ลงชื่อ <span style="border-bottom: 1px dotted black; width: 150px; display: inline-block;"></span> ผู้จอง
                   </div>
                   <img src="{{lesseeSignature}}" style="height: 40px; position: absolute; bottom: 5px; left: 50%; transform: translateX(-50%); z-index: 20; display: {{lesseeSignature ? 'block' : 'none'}}" />
                </div>
                <div>Tenant</div>
...
export const DEFAULT_RECEIPT_LAYOUT = `<style>
  @import url('https://fonts.googleapis.com/css2?family=Sarabun:wght@400;700&display=swap');
  @media print {
    @page {
      size: A4;
